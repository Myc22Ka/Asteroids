...
Explosion::Explosion(Vector2f position, float asteroidSize) : Entity(position, 0, 256, Color::Cyan, getSprite(setRandomSprite())) {
...
Explosion::Explosion(Vector2f position, float s, SpriteInfo spriteInfo) : Entity(position, 0, 256, Color::Cyan, spriteInfo)
{
